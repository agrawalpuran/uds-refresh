...
OrderSchema.index({ companyId: 1, pr_status: 1 }) // Compound index for PR status queries by company
OrderSchema.index({ pr_status: 1, companyId: 1 }) // Reverse compound index for PR status queries
