/**
 * Auto-generated API Tests for /company/invoices/approve
 * Generated: 2026-01-08T09:42:34.196Z
 */
...
const routePath = '/company/invoices/approve'
const routeName = 'company_invoices_approve'
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "invoiceId": "test-value",
          "approvedBy": "test-value"
} })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('POST', routePath, {
        ...
        body: { invoiceId: '507f1f77bcf86cd799439011' }
      })
