/**
 * Auto-generated API Tests for /product-subcategory-mappings
 * Generated: 2026-01-08T09:42:34.285Z
 */
...
const routePath = '/product-subcategory-mappings'
const routeName = 'product-subcategory-mappings'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /product-subcategory-mappings =====
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          ...
          "productId": mocks.mockProduct.id,
          "subCategoryId": mocks.mockCategory.id,
          "mappingId": "test-value"
} })
    ...
    addResult(results, createTestResult('GET', 'No ObjectId fallback', false,
      'Route contains ObjectId fallback patterns - needs manual review', ['ObjectId fallback detected']))


    // ===== POST /product-subcategory-mappings =====
    ...
    // WARNING: Route may still have ObjectId fallback logic
    addResult(results, createTestResult('POST', 'No ObjectId fallback', false,
      'Route contains ObjectId fallback patterns - needs manual review', ['ObjectId fallback detected']))
    ...
    // WARNING: Route may still have ObjectId fallback logic
    addResult(results, createTestResult('DELETE', 'No ObjectId fallback', false,
      'Route contains ObjectId fallback patterns - needs manual review', ['ObjectId fallback detected']))
