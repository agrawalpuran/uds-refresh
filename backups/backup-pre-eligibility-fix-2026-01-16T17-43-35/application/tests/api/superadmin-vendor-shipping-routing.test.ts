/**
 * Auto-generated API Tests for /superadmin/vendor-shipping-routing
 * Generated: 2026-01-08T09:42:34.394Z
 */
...
const routePath = '/superadmin/vendor-shipping-routing'
const routeName = 'superadmin_vendor-shipping-routing'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /superadmin/vendor-shipping-routing =====
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          ...
          "shipmentServiceProviderRefId": "test-value",
          "isActive": "test-value"
} })
    ...
    // ===== POST /superadmin/vendor-shipping-routing =====
