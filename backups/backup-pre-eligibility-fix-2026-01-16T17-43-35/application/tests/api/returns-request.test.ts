/**
 * Auto-generated API Tests for /returns/request
 * Generated: 2026-01-08T09:42:34.317Z
 */
...
const routePath = '/returns/request'
const routeName = 'returns_request'
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          "orderId": "mocks.mockOrder.id",
          "itemIndex": "test-value",
          "requestedQty": "test-value",
          "returnWindowDays": "test-value"
} })
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        ...
        body: { originalOrderId: 'invalid-value' }
      })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        ...
        body: { originalOrderId: '507f1f77bcf86cd799439011' }
      })
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "originalOrderId": "mocks.mockOrder.id",
          "originalOrderItemIndex": "test-value",
          "requestedQty": "test-value",
          "requestedSize": "test-value",
          "reason": "test-value",
          "comments": "test-value",
          "requestedBy": "test-value",
          "returnWindowDays": "test-value",
          "": "test-value"
} })
