/**
 * Auto-generated API Tests for /companies/[companyId]/shipping-providers
 * Generated: 2026-01-08T09:42:34.176Z
 */
...
const routePath = '/companies/[companyId]/shipping-providers'
const routeName = 'companies_[companyId]_shipping-providers'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /companies/[companyId]/shipping-providers =====
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        ...
        body: { providerId: '507f1f77bcf86cd799439011' }
      })
    ...
    // ===== POST /companies/[companyId]/shipping-providers =====
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "isEnabled = true": "test-value",
          "isDefault = false": "test-value",
          "credentials": "test-value",
          "createdBy": "test-value",
          "isEnabled": "test-value",
          "isDefault": "test-value",
          "updatedBy": "test-value"
} })
    ...
    // ===== PUT /companies/[companyId]/shipping-providers =====
