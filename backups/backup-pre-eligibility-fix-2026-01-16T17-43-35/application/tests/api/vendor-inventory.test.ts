/**
 * Auto-generated API Tests for /vendor-inventory
 * Generated: 2026-01-08T09:42:34.410Z
 */
...
const routePath = '/vendor-inventory'
const routeName = 'vendor-inventory'
    ...
    try {
      ...
      const request = createMockRequest('PUT', routePath,
        { body: {
          "vendorId": mocks.mockVendor.id,
          "productId": mocks.mockProduct.id,
          "sizeInventory": "test-value",
          "lowInventoryThreshold": "test-value"
} })
