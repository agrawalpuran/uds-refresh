/**
 * Auto-generated API Tests for /vendor/warehouses
 * Generated: 2026-01-08T09:42:34.424Z
 */
...
const routePath = '/vendor/warehouses'
const routeName = 'vendor_warehouses'
  ...
  try {
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        ...
        body: { warehouseName: 'invalid-value' }
      })
