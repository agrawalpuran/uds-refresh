/**
 * Auto-generated API Tests for /designation-subcategory-eligibilities
 * Generated: 2026-01-08T09:42:34.211Z
 */
...
const routePath = '/designation-subcategory-eligibilities'
const routeName = 'designation-subcategory-eligibilities'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /designation-subcategory-eligibilities =====
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          ...
          "designationId": "test-value",
          "subCategoryId": mocks.mockCategory.id,
          "status": "active",
          "eligibilityId": "test-value"
} })
    ...
    // ===== POST /designation-subcategory-eligibilities =====
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "designationId": "test-value",
          "subCategoryId": mocks.mockCategory.id,
          "gender = 'unisex'": "test-value",
          "quantity": 1,
          "renewalFrequency": "test-value",
          "renewalUnit = 'months'": "test-value",
          "eligibilityId": "test-value",
          "renewalUnit": "test-value",
          "status": "active"
} })
    ...
    // ===== PUT /designation-subcategory-eligibilities =====
    ...
    // ===== DELETE /designation-subcategory-eligibilities =====
