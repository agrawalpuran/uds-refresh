/**
 * Auto-generated API Tests for /superadmin/create-test-orders
 * Generated: 2026-01-08T09:42:34.360Z
 */
...
const routePath = '/superadmin/create-test-orders'
const routeName = 'superadmin_create-test-orders'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== POST /superadmin/create-test-orders =====
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "branchId": "test-value",
          "vendorIds": mocks.mockVendor.id,
          "numEmployees": "test-value",
          "autoApproveLocationAdmin = true": "test-value"
} })
