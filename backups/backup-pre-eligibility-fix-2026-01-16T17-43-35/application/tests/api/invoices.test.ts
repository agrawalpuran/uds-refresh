/**
 * Auto-generated API Tests for /invoices
 * Generated: 2026-01-08T09:42:34.250Z
 */
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "invoice_number": "test-value",
          "invoice_date": "test-value",
          "invoice_amount": "test-value",
    ...
    try {
      const invalidRequest = createMockRequest('POST', routePath, {
        ...
        body: { vendor_indent_id: 'invalid-value' }
      })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('POST', routePath, {
        ...
        body: { vendor_indent_id: '507f1f77bcf86cd799439011' }
      })
