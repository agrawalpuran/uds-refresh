/**
 * Auto-generated API Tests for /superadmin/feature-config
 * Generated: 2026-01-08T09:42:34.363Z
 */
...
const routePath = '/superadmin/feature-config'
const routeName = 'superadmin_feature-config'
  ...
  try {
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        ...
        body: { testOrdersEnabled: 'invalid-value' }
      })
