/**
 * Auto-generated API Tests for /superadmin/shipping-config
 * Generated: 2026-01-08T09:42:34.384Z
 */
...
const routePath = '/superadmin/shipping-config'
const routeName = 'superadmin_shipping-config'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /superadmin/shipping-config =====
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        ...
        body: { shippingIntegrationEnabled: 'invalid-value' }
      })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        ...
        body: { allowMultipleProvidersPerCompany: '507f1f77bcf86cd799439011' }
      })
    ...
    // ===== PUT /superadmin/shipping-config =====
    ...
    try {
      ...
      const request = createMockRequest('PUT', routePath,
        { body: {
          "shippingIntegrationEnabled": "test-value",
          "allowMultipleProvidersPerCompany": "test-value",
