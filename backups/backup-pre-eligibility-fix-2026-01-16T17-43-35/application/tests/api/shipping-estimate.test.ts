/**
 * Auto-generated API Tests for /shipping/estimate
 * Generated: 2026-01-08T09:42:34.345Z
 */
...
const routePath = '/shipping/estimate'
const routeName = 'shipping_estimate'
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "sourcePincode": "test-value",
          "destinationPincode": "test-value",
          "shipmentPackageId": "test-value",
          "weightDetails": "test-value",
    ...
    try {
      const invalidRequest = createMockRequest('POST', routePath, {
        ...
        body: { sourcePincode: 'invalid-value' }
      })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('POST', routePath, {
        ...
        body: { shipmentPackageId: '507f1f77bcf86cd799439011' }
      })
