/**
 * Auto-generated API Tests for /shipping/packages/[packageId]
 * Generated: 2026-01-08T09:42:34.350Z
 */
...
const routePath = '/shipping/packages/[packageId]'
const routeName = 'shipping_packages_[packageId]'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /shipping/packages/[packageId] =====
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        ...
        body: { packageName: 'invalid-value' }
      })
    ...
    // ===== PUT /shipping/packages/[packageId] =====
    ...
    try {
      ...
      const request = createMockRequest('PUT', routePath,
        { body: {
          ...
          "lengthCm": "test-value",
          "breadthCm": "test-value",
          "heightCm": "test-value",
          "volumetricDivisor": "test-value",
          "isActive": "test-value"
} })
    ...
    // ===== DELETE /shipping/packages/[packageId] =====
