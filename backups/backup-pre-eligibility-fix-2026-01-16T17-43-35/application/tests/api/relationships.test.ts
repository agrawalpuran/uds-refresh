/**
 * Auto-generated API Tests for /relationships
 * Generated: 2026-01-08T09:42:34.308Z
 */
...
const routePath = '/relationships'
const routeName = 'relationships'
  ...
  try {
    ...
    try {
      const invalidRequest = createMockRequest('GET', routePath, {
        query: { type: 'invalid-id' },
        body: { type: 'invalid-value' }
      })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        query: { productId: '507f1f77bcf86cd799439011' },
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "type": "test-value",
          "productId": mocks.mockProduct.id,
          "productIds": mocks.mockProduct.id,
          "companyId": mocks.mockCompany.id,
          "vendorId": mocks.mockVendor.id
} })
