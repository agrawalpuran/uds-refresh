/**
 * Auto-generated API Tests for /shipment/provider-couriers
 * Generated: 2026-01-08T09:42:34.319Z
 */
...
const routePath = '/shipment/provider-couriers'
const routeName = 'shipment_provider-couriers'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    // ===== GET /shipment/provider-couriers =====
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        query: { providerCode: '507f1f77bcf86cd799439011' }
