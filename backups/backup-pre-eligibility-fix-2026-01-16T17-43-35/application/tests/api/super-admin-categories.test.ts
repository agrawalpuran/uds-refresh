/**
 * Auto-generated API Tests for /super-admin/categories
 * Generated: 2026-01-08T09:42:34.357Z
 */
...
const routePath = '/super-admin/categories'
const routeName = 'super-admin_categories'
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          "status": "active",
          "categoryId": mocks.mockCategory.id
} })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        query: { categoryId: '507f1f77bcf86cd799439011' },
        body: { categoryId: '507f1f77bcf86cd799439011' }
      })
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "name": "Test Name",
          "isSystemCategory = false": "test-value",
          "categoryId": mocks.mockCategory.id,
          "status": "active"
} })
