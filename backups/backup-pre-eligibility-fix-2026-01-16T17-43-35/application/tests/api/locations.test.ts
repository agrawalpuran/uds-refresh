/**
 * Auto-generated API Tests for /locations
 * Generated: 2026-01-08T09:42:34.253Z
 */
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          ...
          "locationId": mocks.mockLocation.id,
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "pincode": "test-value",
          "phone": "test-value",
          "locationEmail": "mocks.mockEmployee.email",
          "status": "active",
          "locationId": mocks.mockLocation.id,
          "...updateFields": "test-value"
} })
