/**
 * Auto-generated API Tests for /feedback
 * Generated: 2026-01-08T09:42:34.230Z
 */
...
const routePath = '/feedback'
const routeName = 'feedback'
    ...
    try {
      ...
      const request = createMockRequest('GET', routePath,
        { query: {
          ...
          "userEmail": "mocks.mockEmployee.email"
} })
