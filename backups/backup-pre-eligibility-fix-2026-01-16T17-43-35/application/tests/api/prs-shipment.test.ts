/**
 * Auto-generated API Tests for /prs/shipment
 * Generated: 2026-01-08T09:42:34.304Z
 */
...
const routePath = '/prs/shipment'
const routeName = 'prs_shipment'
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "prId": "test-value",
          "shipmentData": "test-value",
          "vendorId": mocks.mockVendor.id,
          "deliveryData": "test-value"
} })
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('POST', routePath, {
        ...
        body: { prId: '507f1f77bcf86cd799439011' }
      })
    ...
    // WARNING: Route may still have ObjectId fallback logic
    addResult(results, createTestResult('PUT', 'No ObjectId fallback', false,
      'Route contains ObjectId fallback patterns - needs manual review', ['ObjectId fallback detected']))
