/**
 * Auto-generated API Tests for /designation-eligibility
 * Generated: 2026-01-08T09:42:34.206Z
 */
...
const routePath = '/designation-eligibility'
const routeName = 'designation-eligibility'
...
export async function runTests(): Promise<TestResult[]> {
  ...
  try {
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "companyId": mocks.mockCompany.id,
          "designation": "test-value",
          "allowedProductCategories": "test-value",
          "itemEligibility": "test-value",
          "gender": "test-value",
          "eligibilityId": "test-value",
          "status": "active",
          "refreshEligibility": "test-value"
} })
    ...
    // ===== DELETE /designation-eligibility =====
