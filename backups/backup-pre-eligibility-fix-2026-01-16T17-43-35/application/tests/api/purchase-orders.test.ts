/**
 * Auto-generated API Tests for /purchase-orders
 * Generated: 2026-01-08T09:42:34.306Z
 */
...
const routePath = '/purchase-orders'
const routeName = 'purchase-orders'
  ...
  try {
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        ...
        body: { orderIds: '507f1f77bcf86cd799439011' }
      })
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          "orderIds": "mocks.mockOrder.id",
          "poNumber": "test-value",
          "poDate": "test-value",
          "companyId": mocks.mockCompany.id,
          "createdByUserId": "test-value"
} })
