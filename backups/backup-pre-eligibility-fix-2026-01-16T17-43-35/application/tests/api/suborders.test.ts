/**
 * Auto-generated API Tests for /suborders
 * Generated: 2026-01-08T09:42:34.354Z
 */
...
const routePath = '/suborders'
const routeName = 'suborders'
  ...
  try {
    ...
    try {
      ...
      const objectIdRequest = createMockRequest('GET', routePath, {
        ...
        body: { order_id: '507f1f77bcf86cd799439011' }
      })
    ...
    try {
      ...
      const request = createMockRequest('POST', routePath,
        { body: {
          ...
          "vendor_indent_id": "test-value",
          "suborder_id": "test-value",
          "shipper_name": "Test Name",
          "consignment_number": "test-value",
          "shipping_date": "test-value",
          "shipment_status": "active",
          "vendorId": mocks.mockVendor.id,
          "// For vendor authorization": "test-value"
} })
