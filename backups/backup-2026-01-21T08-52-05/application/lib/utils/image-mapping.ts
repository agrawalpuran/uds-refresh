...
export function getIndigoUniformImage(
  ...
  if (normalizedProductName) {
    ...
    // Tie uses tie-unisex.jpg
    if (normalizedProductName.includes('tie') && (normalizedCategory === 'accessory' || normalizedCategory === 'belt')) {
  ...
  if (normalizedCategory === 'belt' || normalizedCategory === 'accessory') {
