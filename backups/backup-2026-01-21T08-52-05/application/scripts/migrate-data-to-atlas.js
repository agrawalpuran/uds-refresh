...
const MONGODB_URI = process.env.MONGODB_URI_LOCAL || 'mongodb://localhost:27017/uniform-distribution'
const MONGODB_URI_ATLAS = process.env.MONGODB_URI_ATLAS || 'mongodb+srv://admin:Welcome%40123@cluster0.5g85nve.mongodb.net/uniform-distribution?retryWrites=true&w=majority'
...
async function migrateData() {
  ...
  try {
    ...
    localClient = new MongoClient(MONGODB_URI)
