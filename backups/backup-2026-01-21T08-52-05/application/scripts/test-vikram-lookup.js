/**
 * Test if getEmployeeByEmail can find Vikram Gupta
 */
...
async function testLookup() {
  ...
  try {
    ...
    if (employee) {
      ...
      console.log('')
      console.log('This means getEmployeeByEmail is failing to find the employee.')
      console.log('Possible causes:')
      console.log('  1. Email encryption format mismatch')
      console.log('  2. Employee not in database')
