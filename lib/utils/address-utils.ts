 ...
 * Address Utilities
 * 
 * Pure utility functions for address operations that can run on both client and server.
 * These functions do NOT depend on mongoose or any server-side libraries.
 */
